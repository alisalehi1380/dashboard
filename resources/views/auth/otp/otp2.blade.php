...
@php use \App\Http\Controllers\Auth\Requests\OtpRequest @endphp
@section('content')
    <div class="row">
        <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                @dump(session()->all())
                <div class="card-body">
                    <form role="form" class="text-start" method="post" action="{{ route('otp2.post') }}">
                        @csrf
                        <div class="input-group input-group-outline my-3">
                            <label class="form-label">کد ارسال شده را وارد کنید</label>
                            <input type="number" class="form-control @error(OtpRequest::OTP) is-invalid @enderror" name="{{ OtpRequest::OTP }}" required>
                            @error(OtpRequest::OTP)
