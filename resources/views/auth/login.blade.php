                ...
                <div class="card-body">
                    <form role="form" class="text-start" method="post" action="{{ route('login.post') }}">
                        ...
                        <div class="input-group input-group-outline my-3">
                            ...
                            <input type="number" class="form-control @error(LoginRequest::MOBILE) is-invalid @enderror" name="{{ LoginRequest::MOBILE }}" required>
                            @error(LoginRequest::MOBILE)<span class="invalid-feedback" role="alert" style="text-align: right"><strong>{{ $message }}</strong></span>@enderror
                        </div>
