...
<body class="g-sidenav-show rtl bg-gray-200">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-end">
                ساخت و طراحی توسط شرکت
                <a href="https://asamdata.com" class="font-weight-bold text-white" target="_blank" style="color: #D81B60 !important; margin-right: 0.25rem;">آسام دیتا</a>
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="#/" class="nav-link text-muted" target="_blank">جلسه بعدی</a>
                </li>
                <li class="nav-item">
                  <a href="#/" class="nav-link text-muted" target="_blank">درباره ما</a>
                </li>
                <li class="nav-item">
                  <a href="#/" class="nav-link text-muted" target="_blank">وبلاگ</a>
                </li>
                <li class="nav-item">
                  <a href="#/" class="nav-link pe-0 text-muted" target="_blank">پرونده ها</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <script>
    ...
    new Chart(ctx, {
      type: "bar",
      data: {
        labels: ["فرو", "ارد", "خرد", "تیر", "مرد", "شهر", "مهر"],
        datasets: [{
          label: "فروش",
          tension: 0.4,
          borderWidth: 0,
